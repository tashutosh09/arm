...
const RuleGroup_1 = require("../services/RuleGroup");
class RouterRuleGroup {
    constructor() {
    ...
    handle(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.params && req.params.action) {
                ...
                if (query) {
                    try {
                        const ruleGroups = yield (new RuleGroup_1.RuleGroupService()).getRuleGroups();
                        res.send({
                            status: true,
                            results: ruleGroups
                        });
...
exports.RouterRuleGroup = RouterRuleGroup;
